...
W = diag([1 1 1 0.1 0.1 0.1]);    % Weighting matrix for the velocity vector W * xdot
...
q0 = ones(1,6);                                                            % Initial guess for joint angles
qMatrix(1,:) = p560.ikcon(T,q0);                                            % Solve joint angles to achieve first waypoints 
