...
for i =1:9
    ...
    if(distUR3<= distUR5)&&(distUR3<=UR3TransveralReach)
        UR3Bricks = [UR3Bricks,brick{i}]; %#ok<AGROW>
        NumberUR3Bricks=NumberUR3Bricks+1;
    elseif (distUR5<=UR5TransveralReach)
        UR5Bricks = [UR5Bricks,brick{i}]; %#ok<AGROW> 
        NumberUR5Bricks=NumberUR5Bricks+1;
    else    
        UnnallocatedBricks = [UnnallocatedBricks,brick{i}]  ; %#ok<AGROW>
    end
end
...
%% Kinematics
steps=60;
mode =2; % Mode 1 for single arm movement, Mode 2 double arm movement (Order UR3 to UR5). Mode 3 for automated mode.
...
if mode ==1
    ...
    qmatrix_{1} = robotMotion.interpolateJointAnglesUR3(q1_{1},q2_{1},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{1} = robotMotion.interpolateJointAnglesUR3(q3_{1},q4_{1},steps);
    ...
    qmatrix_{2} = robotMotion.interpolateJointAnglesLinearUR5(q1_{2},q2_{2},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{2} = robotMotion.interpolateJointAnglesLinearUR5(q3_{2},q4_{2},steps);
    ...
    qmatrix_{3} = robotMotion.interpolateJointAnglesUR3(q1_{3},q2_{3},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{3} = robotMotion.interpolateJointAnglesUR3(q3_{3},q4_{3},steps);
    ...
    qmatrix_{4} = robotMotion.interpolateJointAnglesLinearUR5(q1_{4},q2_{4},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{4} = robotMotion.interpolateJointAnglesLinearUR5(q3_{4},q4_{4},steps);
    ...
    qmatrix_{5} = robotMotion.interpolateJointAnglesUR3(q1_{5},q2_{5},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{5} = robotMotion.interpolateJointAnglesUR3(q3_{5},q4_{5},steps);
    ...
    qmatrix_{6} = robotMotion.interpolateJointAnglesLinearUR5(q1_{6},q2_{6},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{6} = robotMotion.interpolateJointAnglesLinearUR5(q3_{6},q4_{6},steps);
    ...
    qmatrix_{7} = robotMotion.interpolateJointAnglesUR3(q1_{7},q2_{7},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{7} = robotMotion.interpolateJointAnglesUR3(q3_{7},steps);
    ...
    qmatrix_{8} = robotMotion.interpolateJointAnglesLinearUR5(q1_{8},q2_{8},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{8} = robotMotion.interpolateJointAnglesLinearUR5(q3_{8},steps);
    ...
    if brickCollected ==true
        ...
        qmatrixDes_{9} = robotMotion.interpolateJointAnglesLinearUR5(q3_{9},q4_{9},steps);
...
elseif mode ==2
    ...
    if brickCollected ==true
        q3_{7} = qmatrix_{7}(end,:);
        [q4_{7},err4_{7},exitflag4_{7}]=UR3A.model.ikcon(brickDestiny{4},q3_{7});
        qmatrixDes_{7} = robotMotion.interpolateJointAnglesUR3(q3_{7},q4_{7},steps);
        q3_{8} = qmatrix_{8}(end,:);
        [q4_{8},err4_{8},exitflag4_{8}]=UR5A.model.ikcon(brickDestiny{8},q3_{8});
        qmatrixDes_{8} = robotMotion.interpolateJointAnglesLinearUR5(q3_{8},q4_{8},steps);
...
for i=1:NumberUR3Bricks
   ...
   qmatrix_{i} = robotMotion.interpolateJointAnglesUR3(q1_{i},q2_{i},steps);
   qUR3 = [qUR3;qmatrix_{i}];
